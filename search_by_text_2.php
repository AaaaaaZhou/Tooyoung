...
$source = exec("/home/sunknight/miniconda2/bin/python
 python search_sort_by_views.py ".$content." 2>&1", $arr, $ret);
...
if(!isset($_SESSION['name'])) {
    ...
    <ul>
    <li>
        <form action="search_by_text_2.php" method="GET">
    ...
    <ul id="nav">
    <li><a href="homepage2.php">返回</a></li>
    <li><a href="image_search.html">以图搜图</a></li>
    <li><a href="homepage.php">按综合排序搜索</a></li>
    </ul>
...
<?php
    ...
    $res = explode(' ', $source);
    $lim = count($res) / 6;
    $query = "select Info from UserInfo where UserName='".$_SESSION['name']."';";
    ...
    $info = $info.' '.$content;
    $update = "update UserInfo set Info='".$info."' where UserName='".$_SESSION['name']."';";
